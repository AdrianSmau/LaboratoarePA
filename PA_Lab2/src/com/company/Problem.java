...
public class Problem {
    ...
    public Problem(Source[] sources, Destination[] destinations, int[] supply, int[] demand, int[][] cost) {
        if((sources.length != supply.length) || (destinations.length != demand.length) || (cost.length * cost.length != supply.length * demand.length) || (!checkSources(sources)) || (!checkDestinations(destinations)) || (!checkEquality(supply,demand))){
