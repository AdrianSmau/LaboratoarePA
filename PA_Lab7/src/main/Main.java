...
public class Main {
    ...
    public static void main(String[] args) {
        Board gameBoard = new Board(5); // GameBoard
        Player[] players = new Player[4]; // Players
        players[0] = new Player("Adrian", gameBoard, true, true);
        players[1] = new Player("Ben", gameBoard, true, false);
        players[2] = new Player("Corneliu", gameBoard, true, false);
        players[3] = new Player("Damian", gameBoard, true, false);
